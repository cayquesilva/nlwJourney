...
export function App() {
  ...
  function addNewEmailToInvite(event: FormEvent<HTMLFormElement>){
    //evitar de resetar a pagina por conta de ser um form "submit" que o padrão é ir pra outra pagina
    ...
    //espread operator, mantem a lista e adiciona ao final o item (imutabilidade)
      ...
      <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
        <div className="max-w-3xl w-full px-6 text-center space-y-10">
          ...
          <div className="space-y-4">
            ...
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              ...
              <div className="flex items-center gap-2"> 
                ...
                <input disabled={isGuestsInputOpen} type="text" placeholder="Quando?" className="bg-transparent text-lg text-zinc-400 w-44 outline-none"/>
              </div>
          ...
          <p className="text-zinc-500 text-sm">
            ...
            com nossos <a href="#" className="text-zinc-300 underline">termos de uso</a> e <a href="#" className="text-zinc-300 underline">politica de privacidade</a>.
          </p>
