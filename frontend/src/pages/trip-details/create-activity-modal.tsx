...
export function CreateActivityModal({closeCreateActivityModal}: CreateActivityModalProps){
    ...
    function createActivity(event: FormEvent<HTMLFormElement>){
        ...
        //para dar refresh foi preciso essa gambiarra
            ...
            <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-zinc-400">
                        Todos os convidados poderão ver a atividade
                    </p>
                </div>
                ...
                <form onSubmit={createActivity} className="space-y-3">
                    ...
                    <div className="h-14 px-4 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2 flex-1">
                        ...
                        <input 
                            type="datetime-local" 
                            name="occurs_at" 
                            className="bg-transparent text-lg text-zinc-400 outline-none flex-1 [color-scheme:dark]"
                        />
                    </div>
