                ...
                return (
                    <div key={day.date} className="space-y-2.5">
                        <div className="flex gap-2 items-baseline">
                            <div className="text-zinc-300 text-xl font-semibold">Dia {format(day.date, 'd')}</div>
                                    ...
                                    return(
                                        <div key={activity.id} className="space-y-2.5">
                                            <div className="px-4 py-2.5 bg-zinc-900 rounded-lg shadow-shape flex items-center gap-3">
                                                ...
                                                <span className="text-zinc-300 ml-auto">{format(activity.occurs_at, 'HH:mm')}h</span>
                                            </div>
                                        </div>
                                    )
                                })}
